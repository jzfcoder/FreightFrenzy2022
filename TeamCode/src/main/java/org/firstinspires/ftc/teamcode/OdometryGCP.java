 ...
 * GCP: Global Coordinate Position
 */
public class OdometryGCP implements Runnable {
    //Odometry wheels
     ...
     */
    public OdometryGCP(DcMotor verticalEncoderLeft, DcMotor verticalEncoderRight, DcMotor horizontalEncoder, double COUNTS_PER_INCH, int threadSleepDelay){
        ...
        robotEncoderWheelDistance = Double.parseDouble(ReadWriteFile.readFile(wheelBaseSeparationFile).trim()) * countsPerInch;
        this.horizontalEncoderTickPerDegreeOffset = Double.parseDouble(ReadWriteFile.readFile(horizontalTickOffsetFile).trim());

    }

    public OdometryGCP(DcMotor verticalEncoderLeft, DcMotor verticalEncoderRight, DcMotor horizontalEncoder, double COUNTS_PER_INCH, double startingX,
     ...
     */
    public double getXinInches(){ return robotGlobalXCoordinatePosition / countsPerInch; }

    /**
     * Returns the robot's global y coordinate
     * @return global y coordinate
     */
    public double getYinInches(){ return robotGlobalYCoordinatePosition / countsPerInch; }

    /**
     * Returns the robot's global x coordinate
     * @return global x coordinate
     */
    public double getXinEticks(){ return robotGlobalXCoordinatePosition; }

    /**
     * Returns the robot's global y coordinate
     * @return global y coordinate
     */
    public double getYinEticks(){ return robotGlobalYCoordinatePosition; }
