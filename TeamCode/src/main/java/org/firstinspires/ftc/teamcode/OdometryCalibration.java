...
public class OdometryCalibration extends LinearOpMode {
    ...
    String rfName = HardwareController.MOTOR_RF, rbName = HardwareController.MOTOR_RB;
    String lfName = HardwareController.MOTOR_LF, lbName = HardwareController.MOTOR_RB;
    String verticalLeftEncoderName = HardwareController.MOTOR_LB;
    String verticalRightEncoderName = HardwareController.MOTOR_RB;
    String horizontalEncoderName = HardwareController.MOTOR_RF;

    final double PIVOT_SPEED = 0.5;

    //The amount of encoder ticks for each inch the robot moves. THIS WILL CHANGE FOR EACH ROBOT AND NEEDS TO BE UPDATED HERE
    final double COUNTS_PER_INCH = Math.PI /  8192;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        parameters.calibrationDataFile = HardwareController.IMU_CALIBRATION_FILENAME; // see the calibration sample opmode
